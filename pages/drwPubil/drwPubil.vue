<template>
	<view >
		...
		<button @click="tn('/pages/index/index?index=1')">
			<view class="dong">
				<view class="monster">
		...
		<view class="tn-margin-sm tn-text-center">
			<!-- 比例图文 start-->
					...
					<view class="" style="width: 50%;" @click="tn('/pages/drwPubil/detailImage?type=1',item)">
						<view class="tn-margin-xs img-shadow" style="border-radius: 10rpx;">
							...
							<view class="" style="padding: 15rpx;">
								<view class="image-picbook" :style="'background-image:url(' + item.image_url + ')'">
							...
							<view class="tn-flex tn-flex-row-between tn-flex-col-center"
								style="padding: 0 15rpx 15rpx 15rpx;">
								<view class="justify-content-item">
									<view class="tn-flex tn-flex-col-center tn-flex-row-left">
										<view class="logo-pic">
											<view class="logo-image">
												<view class=""
													:style="'background-image:url('+ item.userAvatar +');width: 40rpx;height: 40rpx;background-size: cover;border-radius:200rpx'">
												</view>
											</view>
										</view>
										<view class="tn-padding-left-xs">
											<text class="tn-color-black tn-text-sm">{{ item.userName }}</text>
										</view>
								...
								<view class="justify-content-item">
									...
									<text class="tn-color-gray">{{ item.viewUserCount }}</text>
								</view>
							</view>
						</view>
					</view>
