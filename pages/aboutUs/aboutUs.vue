<template>
	<view class="template-outset">
		...
		<view class="tn-text-center tn-color-gray" style="padding: 60vh 0 0 0;">
			<view class="" style="font-size: 45rpx;">
				BitsAi，不止于此
			</view>
			<view class="tn-color-gray tn-text-df tn-padding-top">
				新触动 新感受 新创意
			</view>
		</view>
...
<style lang="scss" scoped>
	...
	.user-info {
		...
		&__avatar {
			...
			animation: breatheHead 3s infinite ease-in-out;
		}
		...
		@keyframes breatheHead {
			...
			0%,
			100% {
				box-shadow: 0px 0px 20px 0px rgb(155, 250, 226 / 15%);
			}

			50% {
				box-shadow: 0px 0px 80px 0px rgb(155, 250, 226 / 25%);
			}
		}
	...
	/* 波浪*/
	.template-outset {
		background-image: linear-gradient(to top, #C8FFF2 20%, #FFC8E2 80%);
		width: 100vw;
		height: 100vh;
	}
