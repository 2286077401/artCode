<template>
	<view class="">
		<view class="rise-loader" ref="wrapper">
			<text class="_text-bold" :style="{ color: highlightColor, fontSize: fontSize + 'upx' }">{{ text }}</text>
			<view class="rise-under" :style="{ color: underColor }" ref="riseUnder">
				<text class="_text-bold" :style="{ color: underColor, fontSize: fontSize + 'upx' }">{{ text }}</text>
			</view>
		</view>
	</view>
</template>
